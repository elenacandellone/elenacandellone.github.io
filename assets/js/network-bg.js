...
(function () {
  ...
  var CFG = {
    nodeCount: 60,
    posColor: "rgba(250, 204, 106, 0.32)",  // gold — solid ties
    negColor: "rgba(250, 204, 106, 0.20)",  // gold — dashed ties (same hue, dimmer + dashed for texture)
    nodeFill: "rgba(250, 204, 106, 0.55)",
    nodeStroke: "rgba(250, 204, 106, 0.85)",
    nodeRadius: [1.6, 3.4],
